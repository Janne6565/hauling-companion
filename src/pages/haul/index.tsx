...
export function HaulScreen({
  ...
  const deliveryColorMap = useMemo(() => buildDeliveryColorMap(stops), [stops])
    ...
    <div>
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-medium tracking-tight">Hauling</h1>
    ...
    <div>
      ...
      <div className="flex flex-col gap-1.5">
        {entries.map(({ s, i }) => {
          ...
          const isOccupied =
            !isDelivered && isZoneOccupied(i, stops, completedStops)
